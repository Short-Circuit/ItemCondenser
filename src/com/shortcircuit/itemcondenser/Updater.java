...
public class Updater {
    ...
    private String apiKey = "2d63c52d5a3ee4c9448b3a07079b5c189d935d26"; // BukkitDev ServerMods API key
    ...
    public Updater(Main main, int id, File file, UpdateType type, boolean announce) {
        ...
        if (!key.equalsIgnoreCase("2d63c52d5a3ee4c9448b3a07079b5c189d935d26") || key.equals("")) {
            key = null;
        }
